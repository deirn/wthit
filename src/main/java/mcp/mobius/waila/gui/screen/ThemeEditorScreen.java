...
class ThemeEditorScreen extends ConfigScreen {
    ...
    private void buildTheme() {
        ...
        theme.init(ThemeAccessor.INSTANCE);
    }
    ...
    public ConfigListWidget getOptions() {
        ...
        type.properties.forEach((key, prop) -> {
            ...
            Object templateValue = attr.computeIfAbsent(key, k -> prop.exampleValue);
            //            Object templateValue = template.type == type ? prop.get(template.instance) : prop.exampleValue;
            ConfigValue<?> value;
